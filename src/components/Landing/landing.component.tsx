      ...
      <div className="lg:h-screen flex lg:pt-0 pt-12">
        <div className="mx-auto lg:self-center lg:max-w-50 px-12 lg:px-0">
          <div className="hidden lg:block" style={{ minHeight: "12rem" }}>
            <h1 className="relative inline-block text-white text-8xl font-black tracking-tighter">
              Daniel Agg
            </h1>
          </div>
          ...
          <p className="text-white w-5/6 font-thin text-lg">
            ...
            <span className="font-bold">full stack developer</span>, employed by
            Apiumhub, currently working with technologies such as ASP.NET Core
            and React on Azure.
          </p>

          <p className="mt-8 text-white w-5/6 font-thin text-lg">
            More to come, soon.
          </p>
