...
const NotFoundPage = () => {
  return (
      <div className="h-screen flex flex-col lg:justify-center items-center -my-4 lg:pt-0 pt-12">
        <h1 className="text-white text-3xl lg:text-6xl">Sorry, that's a <span className="font-raleway-bold" >404</span>.</h1>
        <p className="text-white text-xl mt-2">This page does not exist.</p>
